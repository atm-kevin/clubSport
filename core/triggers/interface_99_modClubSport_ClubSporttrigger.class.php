...
/**
 * 	\file		core/triggers/interface_99_modMyodule_ClubSporttrigger.class.php
 * 	\ingroup	clubsport
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modClubsport_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfaceClubSporttrigger
{
    ...
    public function run_trigger($action, $object, $user, $langs, $conf)
    {
        ...
        elseif ($action == 'PRODUCT_CREATE') {
	        ...
	        if(!class_exists('ClubSport')){
		        require_once __DIR__ . '/../../class/clubsport.class.php';
	        }
	        $error = 0;
	        $staticModClubSport = new ClubSport($object->db);
	        $TSportActivities = $staticModClubSport->fetchAll('','', $limit = 0, $offset = 0, array('customsql' => 'fk_product = ' . intval($object->id)), 'AND');
	        ...
	        return $error*-1;  // 0 si OK (car $error = 0 par défaut, <0 si il y a une erreur)
